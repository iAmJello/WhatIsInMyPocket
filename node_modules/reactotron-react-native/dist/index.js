...
function mitt(all) {
  ...
  return {
    ...
    emit: function emit(type, event) {
      list('*').concat(list(type)).forEach(function (f) {
        f(event);
      });
    }
  };
...
var asyncStorage = (function (options) {
  return function (reactotron) {
     ...
     */
    var reactotronShipStorageValues = function reactotronShipStorageValues() {
     ...
     */
    var reactotronStorageHijacker = function reactotronStorageHijacker(originalMethod) {
      return function () {
        ...
        originalMethod.apply(undefined, toConsumableArray(newArgs));
      };
    };
    ...
    var trackAsyncStorage = function trackAsyncStorage() {
      ...
      reactNative.AsyncStorage.setItem = reactotronStorageHijacker(swizzSetItem);

      swizzRemoveItem = reactNative.AsyncStorage.removeItem;
      reactNative.AsyncStorage.removeItem = reactotronStorageHijacker(swizzRemoveItem);

      swizzMergeItem = reactNative.AsyncStorage.mergeItem;
      reactNative.AsyncStorage.mergeItem = reactotronStorageHijacker(swizzMergeItem);

      swizzClear = reactNative.AsyncStorage.clear;
      reactNative.AsyncStorage.clear = reactotronStorageHijacker(swizzClear);

      swizzMultiSet = reactNative.AsyncStorage.multiSet;
      reactNative.AsyncStorage.multiSet = reactotronStorageHijacker(swizzMultiSet);

      swizzMultiRemove = reactNative.AsyncStorage.multiRemove;
      reactNative.AsyncStorage.multiRemove = reactotronStorageHijacker(swizzMultiRemove);

      swizzMultiMerge = reactNative.AsyncStorage.multiMerge;
      reactNative.AsyncStorage.multiMerge = reactotronStorageHijacker(swizzMultiMerge);
