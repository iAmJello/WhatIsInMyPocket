    ...
    return {
      features: {
        log: function log(message) {
          ...
          return reactotron.send('log', { level: 'debug', message: message || null }, !!important);
        },
        ...
        warn: function warn(message) {
          return reactotron.send('log', { level: 'warn', message: message || null }, true);
        },
        error: function error(message, stack) {
          return reactotron.send('log', { level: 'error', message: message || null, stack: stack || null }, true);
        }
      }
    };
  };
